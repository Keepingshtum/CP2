...
function CreateMediaPlayer(content as Object, index as Integer) as Object
    ...
    audio.setCertificatesFile("common:/certs/ca-bundle.crt")
    audio.InitClientCertificates()
    audio.AddHeader("Authorization", "Basic YW5hbnQ6ZXh0cmFzYWZldHk=") ' doesn't work yet
