' Template for doing a random code gen for rendezvous linking - to be shown on top of main grid for login before logging in
' This is for mainscene implementation- need to call detailsview if authenticated
